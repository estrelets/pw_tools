...
namespace Pw.RpcDatas
{
    ...
    public class GForceData
    {
        ...
        [Order(1)] public int Reputation { get; set; }

        [Order(2)] public int Contribution { get; set; }
        ...
        [Order(7)] public int Reserved5 { get; set; }

        [Order(8)] public int Reserved6 { get; set; }

        [Order(9)] public int Reserved7 { get; set; }
    }
}
