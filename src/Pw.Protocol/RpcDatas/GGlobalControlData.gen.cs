...
namespace Pw.RpcDatas
{
    ...
    {
        [Order(0)]
        public char CashMoneyExchangeOpen { get; set; }
        [Order(1)]
        public int CashMoneyExchangeRate { get; set; }
        [Order(2)]
        ...
        [Order(7)]
        public List<int> TriggerCtrlList { get; set; }
        [Order(8)]
        public char Reserved12 { get; set; }
        [Order(9)]
        public char Reserved13 { get; set; }
        [Order(10)]
