...
namespace Pw.RpcDatas
{
    ...
    {
        [Order(0)] public GAuctionItem Info { get; set; }

        [Order(1)] public ushort Category { get; set; }

        [Order(2)] public uint Baseprice { get; set; }

        [Order(3)] public uint Deposit { get; set; }

        [Order(4)] public int ElapseTime { get; set; }

        [Order(5)] public int Prolong { get; set; }
        ...
        [Order(9)] public GRoleInventory Item { get; set; }
    }
}
