...
namespace Pw.RpcDatas
{
    ...
    public class SNSRoleBrief
    {
        ...
        [Order(18)]
        public int DamageMagicLow { get; set; }
        [Order(19)]
        public int DamageMagicHigh { get; set; }
        [Order(20)]
        ...
        [Order(33)]
        public int SoulPower { get; set; }
        [Order(34)]
        public uint SkillsCrc { get; set; }
        [Order(35)]
        public uint EquipmentCrc { get; set; }
        [Order(36)]
        public uint PetcorralCrc { get; set; }
        [Order(37)]
