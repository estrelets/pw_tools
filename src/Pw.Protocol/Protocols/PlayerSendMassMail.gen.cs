...
// max context length is 400 bytes
        ...
        [Order(5)] public byte[] SenderName { get; set; }

// below parameter is provide by gameserver
        [Order(6)] public List<int> ReceiverList { get; set; }

        [Order(7)] public int CostObjId { get; set; }

        [Order(8)] public int CostObjNum { get; set; }

        [Order(9)] public int CostObjPos { get; set; }

        [Order(10)] public uint CostMoney { get; set; }

        [Order(11)] public byte[] SyncData { get; set; }
    }
}
