...
namespace Pw.RpcDatas
{
    ...
    public class GFactionFortressInfo
    {
        ...
        [Order(3)]
        public int ExpTodayTime { get; set; }
        [Order(4)]
        ...
        //ÉÏÏÞ100¸öint*2
        [Order(8)]
        public byte[] CommonValue { get; set; }
        //ÉÏÏÞ100¸öint
        [Order(9)]
        public byte[] ActivedSpawner { get; set; }
        [Order(10)]
        public char Reserved11 { get; set; }
        [Order(11)]
        public short Reserved12 { get; set; }
        [Order(12)]
