...
namespace Pw.Protocols
{
    ...
    public class Sold
    {
        ...
        [Order(6)] public long OrderId { get; set; }

        [Order(7)] public int Stype { get; set; }

        [Order(8)] public long Timestamp { get; set; }

        [Order(9)] public int Reserved1 { get; set; }

        [Order(10)] public int Reserved2 { get; set; }
    }
}
