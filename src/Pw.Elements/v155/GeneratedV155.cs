...
namespace Pw.Elements.v155
{
    ...
    public class WeaponEssence : IElementsType
    {
        ...
        [Order(18)]
        public float ProbabilityHide {get; set;}
        ...
        [Order(45)]
        public float ProbabilityAddonNum5 {get; set;}
        ...
        [Order(50)]
        [Size(16)]
        public Probability[] Hides {get; set;}
    ...
    public class ArmorEssence : IElementsType
    {
        ...
        [Order(19)]
        [Size(5)]
        public MagicDefences[] MagicDefences {get; set;}
    ...
    public class FlyswordEssence : IElementsType
    {
        ...
        [Order(21)]
        public int MaxImproveLevel {get; set;}

        [Order(22)]
        [Size(10)]
        public ImproveConfigClass[] ImproveConfig {get; set;}
        ...
        {
            [Order(0)]
            public uint RequireItemNum {get; set;}

            [Order(1)]
            public float SpeedIncrease {get; set;}

            [Order(2)]
            public float SpeedRushIncrease {get; set;}
        }
    ...
    public class StoneEssence : IElementsType
    {
        ...
        [Order(19)]
        public uint IdAddonDecoration {get; set;}
    ...
    public class MonsterEssence : IElementsType
    {
        ...
        [Order(31)]
        [Size(5)]
        public MagicDamagesExtClass[] MagicDamagesExt {get; set;}
        ...
        [Order(55)]
        [Size(5)]
        public SkillHp25Class[] SkillHp75 {get; set;}

        [Order(56)]
        [Size(5)]
        public SkillHp25Class[] SkillHp50 {get; set;}

        [Order(57)]
        [Size(5)]
        public SkillHp25Class[] SkillHp25 {get; set;}
        ...
        [Order(78)]
        public float MaxMoveRange {get; set;}

        [Order(79)]
        public uint DropForNoProfitTime {get; set;}

        [Order(80)]
        public int DropMineConditionFlag {get; set;}

        [Order(81)]
        public float DropMineProbability {get; set;}

        [Order(82)]
        [Size(4)]
        public DropMinesClass[] DropMines {get; set;}
    ...
    public class NpcSellService : IElementsType
    {
        ...
        public class PagesClass
        {
            ...
            [Order(2)]
            public uint RequireForce {get; set;}

            [Order(3)]
            public int RequireForceReputation {get; set;}
            ...
            public class GoodsClass
            {
                ...
                [Order(1)]
                public int ContribCost {get; set;}

                [Order(2)]
                public int ForceContributionCost {get; set;}

                [Order(3)]
                public int SoloTowerChallengeScoreCost {get; set;}
            }
    ...
    public class NpcTaskOutService : IElementsType
    {
        ...
        [Order(8)]
        public int StorageDeliverPerDay {get; set;}
        ...
        [Order(10)]
        public uint StorageRefreshOnCrossserver {get; set;}
    }
    ...
    public class NpcTaskMatterService : IElementsType
    {
        ...
        public class TasksClass
        {
            ...
            [Order(1)]
            [Size(4)]
            public TaksMattersClass[] TaksMatters {get; set;}

            public class TaksMattersClass
            {
                [Order(0)]
                public uint IdMatter {get; set;}

                [Order(1)]
                public int NumMatter {get; set;}
            }
    ...
    public class NpcTransmitService : IElementsType
    {
        ...
        [Order(3)]
        [Size(32)]
        public TargetsClass[] Targets {get; set;}
    ...
    public class NpcTransportService : IElementsType
    {
        ...
        [Order(2)]
        [Size(32)]
        public RoutesClass[] Routes {get; set;}
    ...
    public class NpcEssence : IElementsType
    {
        ...
        [Order(38)]
        public uint IdCrossServerService {get; set;}
        ...
        [Order(44)]
        public uint CombinedServices2 {get; set;}

        [Order(45)]
        public uint IdForceService {get; set;}
    ...
    public class RecipeEssence : IElementsType
    {
        ...
        [Order(20)]
        public float EngraveUpgradeRate {get; set;}

        [Order(21)]
        public float AddonInheritFeeRate {get; set;}
    ...
    public class CharracterClassConfig : IElementsType
    {
        ...
        [Order(25)]
        [Size(6)]
        public float[] SpiritAdjust {get; set;}

        [Order(26)]
        [Size(6)]
        public float[] PokerAdjust {get; set;}
    }
    ...
    public class ParamAdjustConfig : IElementsType
    {
        ...
        [Order(3)]
        [Size(11)]
        public TeamProfessionAdjustClass[] TeamAdjust {get; set;}

        [Order(4)]
        [Size(11)]
        public TeamProfessionAdjustClass[] TeamProfessionAdjust {get; set;}

        [Order(5)]
        public float DmgAdjToSpecAtkSpeed {get; set;}

        [Order(6)]
        public float AtkRateAdjToSpecAtkSpeed {get; set;}

        [Order(7)]
        [Size(10)]
        public float[] UseMonsterSpiritAdjust {get; set;}
    ...
    public class TaskdiceEssence : IElementsType
    {
        ...
        [Order(11)]
        public int NoUseInCombat {get; set;}
    }
    ...
    public class MineEssence : IElementsType
    {
        ...
        [Order(20)]
        [Size(4)]
        public NpcgenClass[] Npcgen {get; set;}

        [Order(21)]
        [Size(1)]
        public AggrosClass[] Aggros {get; set;}
        ...
        [Order(24)]
        public int MaxGatherer {get; set;}

        [Order(25)]
        public int MineType {get; set;}

        [Order(26)]
        public float GatherDist {get; set;}

        [Order(27)]
        public float MaterialGainRatio {get; set;}

        [Order(28)]
        public uint GatherStartActionConfig {get; set;}

        [Order(29)]
        public uint GatherLoopActionConfig {get; set;}
    ...
    public class PetEssence : IElementsType
    {
        ...
        [Order(52)]
        public uint IdPetEggEvolved {get; set;}

        [Order(53)]
        public int CostIndex {get; set;}

        [Order(54)]
        public int HpInheritMaxRate {get; set;}

        [Order(55)]
        public int AttackInheritMaxRate {get; set;}

        [Order(56)]
        public int DefenceInheritMaxRate {get; set;}

        [Order(57)]
        public int AttackLevelInheritMaxRate {get; set;}

        [Order(58)]
        public int DefenceLevelInheritMaxRate {get; set;}

        [Order(59)]
        public int SpecificSkill {get; set;}
        ...
        [Order(61)]
        public uint IdEvolvedSkillRand {get; set;}
    ...
    public class Fireworks2Essence : IElementsType
    {
        ...
        [Order(8)]
        public int MaleMineId {get; set;}

        [Order(9)]
        public int FemaleMineId {get; set;}
    ...
    public class RefineTicketEssence : IElementsType
    {
        ...
        [Order(9)]
        public uint BindingOnly {get; set;}
    ...
    public class GoblinEssence : IElementsType
    {
        ...
        [Order(22)]
        [Size(10)]
        public RandPropClass[] RandProp {get; set;}
    ...
    public class TargetItemEssence : IElementsType
    {
        ...
        [Order(15)]
        public uint UseInSanctuaryOnly {get; set;}
        ...
        [Order(17)]
        [Size(32)]
        public int[] TargetIdForPop {get; set;}

        [Order(18)]
        public uint TargetFaction {get; set;}
    ...
    public class UpgradeProductionConfig : IElementsType
    {
        ...
        [Order(6)]
        [Size(3)]
        public int[] NumEngrave {get; set;}

        [Order(7)]
        [Size(5)]
        public int[] NumAddon {get; set;}

        [Order(8)]
        [Size(80)]
        public int[] NumDecoration {get; set;}
    }
    ...
    public class FaceHairTextureMap : IElementsType
    {
        ...
        [Order(2)]
        [Size(128)]
        public HairTextureMapClass[] HairTextureMap {get; set;}
    ...
    public class WeddingConfig : IElementsType
    {
        ...
        [Order(3)]
        [Size(20)]
        public ReservedDayClass[] ReservedDay {get; set;}
    ...
    public class FactionFortressConfig : IElementsType
    {
        ...
        [Order(3)]
        [Size(8)]
        public RequireItemClass[] RequireItem {get; set;}
        ...
        [Order(8)]
        [Size(100)]
        public CommonValueClass[] CommonValue {get; set;}
    ...
    public class CongregateEssence : IElementsType
    {
        ...
        public class AreaClass
        {
            ...
            [Order(2)]
            public int RequireReplyLevel {get; set;}

            [Order(3)]
            public int RequireReplyLevel2 {get; set;}

            [Order(4)]
            public int RequireReplyReincarnationTimes {get; set;}
        }
    ...
    public class ForceConfig : IElementsType
    {
        ...
        [Order(6)]
        public int ContributionMax {get; set;}

        [Order(7)]
        public int JoinMoneyCost {get; set;}

        [Order(8)]
        public int JoinItemCost {get; set;}

        [Order(9)]
        public int QuitReputionCost {get; set;}

        [Order(10)]
        public int QuitContributionCost {get; set;}
    }
    ...
    public class ForceTokenEssence : IElementsType
    {
        ...
        [Order(5)]
        public int ReputationAdd {get; set;}

        [Order(6)]
        public int ReputationIncreaseRatio {get; set;}
    ...
    public class CountryConfig : IElementsType
    {
        ...
        [Order(3)]
        [Size(3)]
        public int[] FlagControllerId {get; set;}

        [Order(4)]
        public uint FlagMineId {get; set;}

        [Order(5)]
        [Size(3)]
        public float[] AttackFlagGoal {get; set;}

        [Order(6)]
        public float AttackFlagGoalRadius {get; set;}

        [Order(7)]
        [Size(3)]
        public float[] DefenceFlagGoal {get; set;}

        [Order(8)]
        public float DefenceFlagGoalRadius {get; set;}

        [Order(9)]
        [Size(9)]
        public DefenceTowerClass[] AttackTower {get; set;}

        [Order(10)]
        [Size(9)]
        public DefenceTowerClass[] DefenceTower {get; set;}

        [Order(11)]
        [Size(8)]
        public StrongholdClass[] Stronghold {get; set;}
    ...
    public class PetEvolveConfig : IElementsType
    {
        ...
        public class CostClass
        {
            ...
            [Order(2)]
            [Size(6)]
            public int[] NumRandSkill {get; set;}
        }
    ...
    public class StoneChangeRecipe : IElementsType
    {
        ...
        [Order(3)]
        public uint IdOldStone {get; set;}

        [Order(4)]
        public uint IdNewStone {get; set;}
    ...
    public class MeridianConfig : IElementsType
    {
        ...
        [Order(2)]
        [Size(12)]
        public ProfParaClass[] ProfPara {get; set;}
    ...
    public class PetEvolvedSkillRandConfig : IElementsType
    {
        ...
        [Order(2)]
        [Size(3)]
        public RandSkillGroupClass[] RandSkillGroup {get; set;}
    ...
    public class TouchShopConfig : IElementsType
    {
        ...
        public class PageClass
        {
            ...
            public class ItemClass
            {
                ...
                [Order(3)]
                public int ExpireTimelength {get; set;}
            }
    ...
    public class PlayerReincarnationConfig : IElementsType
    {
        ...
        public class LevelClass
        {
            ...
            [Order(1)]
            public float ExpPremote {get; set;}
        }
    ...
    public class HistoryStageConfig : IElementsType
    {
        ...
        [Order(3)]
        public int ProgressValueId {get; set;}

        [Order(4)]
        public int ProgressValueGoal {get; set;}
    }
    ...
    public class HistoryAdvanceConfig : IElementsType
    {
        ...
        [Order(2)]
        [Size(32)]
        public int[] HistoryStageId {get; set;}
    }
    ...
    public class AutoteamConfig : IElementsType
    {
        ...
        [Order(6)]
        [Size(2)]
        public int[] RequireMaxlevel {get; set;}

        [Order(7)]
        public int RequireGender {get; set;}
        ...
        [Order(10)]
        public int RequireLevel2 {get; set;}

        [Order(11)]
        [Size(2)]
        public int[] RequireReincarnationTimes {get; set;}

        [Order(12)]
        [Size(2)]
        public int[] RequireRealmLevel {get; set;}

        [Order(13)]
        public int RequireSoulPower {get; set;}
        ...
        [Order(15)]
        [Size(3)]
        public float[] TransPos {get; set;}

        [Order(16)]
        [Size(32)]
        public int[] WorldtagFrom {get; set;}
    ...
    public class ChariotConfig : IElementsType
    {
        ...
        [Order(7)]
        public float HpIncRatio {get; set;}
    ...
    public class ChariotWarConfig : IElementsType
    {
        ...
        [Order(2)]
        [Size(3)]
        public MinesClass[] Mines {get; set;}
    ...
    public class PokerLevelexpConfig : IElementsType
    {
        ...
        [Order(3)]
        [Size(5)]
        public float[] ExpAdjust {get; set;}
    }
    ...
    public class PokerSuiteEssence : IElementsType
    {
        ...
        [Order(2)]
        public float PromoteRatio {get; set;}
    ...
    public class PokerDiceEssence : IElementsType
    {
        ...
        [Order(4)]
        public int SwallowExp {get; set;}

        [Order(5)]
        [Size(256)]
        public Probability[] List {get; set;}
    ...
    public class PokerSubType : IElementsType
    {
        ...
        [Order(3)]
        public ulong EquipMask {get; set;}
    }
    ...
    public class PokerEssence : IElementsType
    {
        ...
        [Order(8)]
        [Size(2)]
        public int[] RequireControlPoint {get; set;}
        ...
        [Order(19)]
        public int IncMagicDamage {get; set;}

        [Order(20)]
        public int IncDefence {get; set;}

        [Order(21)]
        [Size(5)]
        public int[] IncMagicDefence {get; set;}

        [Order(22)]
        public int IncVigour {get; set;}
    ...
    public class ShopTokenEssence : IElementsType
    {
        ...
        [Order(4)]
        public uint IdTokenShop {get; set;}
    ...
    public class GtConfig : IElementsType
    {
        ...
        [Order(2)]
        public int IncAttackDegree {get; set;}

        [Order(3)]
        public int IncDefendDegree {get; set;}
    }
    ...
    public class RandShopConfig : IElementsType
    {
        ...
        [Order(2)]
        public int FirstBuyPrice {get; set;}

        [Order(3)]
        public int FirstBuyRange {get; set;}
    ...
    public class FactionPvpConfig : IElementsType
    {
        ...
        public class ListClass
        {
            ...
            [Order(1)]
            public int MinebaseGenCount {get; set;}

            [Order(2)]
            public int PointsPerGenMinecar {get; set;}

            [Order(3)]
            public int BasePoints {get; set;}

            [Order(4)]
            public int MinecarCountCanRob {get; set;}

            [Order(5)]
            public int MinebaseCountCanRob {get; set;}
        }
    ...
    public class TaskDiceByWeightConfig : IElementsType
    {
        ...
        [Order(4)]
        [Size(10)]
        public UniformWeightListClass[] UniformWeightList {get; set;}

        [Order(5)]
        public uint OtherTaskListConfigId {get; set;}
        ...
        public class UniformWeightListClass
        {
            ...
            [Order(2)]
            public uint TaskListConfigId {get; set;}
        }
    ...
    public class AstrolabeEssence : IElementsType
    {
        ...
        [Order(6)]
        public int MinInnerPointValue {get; set;}

        [Order(7)]
        public int MaxInnerPointValue {get; set;}

        [Order(8)]
        public int MaxInitInnerPointValue {get; set;}

        [Order(9)]
        public int InitAllInnerPointValue {get; set;}

        [Order(10)]
        public int MaxAllInnerPointValue {get; set;}

        [Order(11)]
        [Size(32)]
        public RandsClass[] Rands {get; set;}

        [Order(12)]
        public uint IdRandWhenFail {get; set;}

        [Order(13)]
        public int BaseSwallowExp {get; set;}
        ...
        {
            [Order(0)]
            public uint IdRand {get; set;}

            [Order(1)]
            public float ProbabilityRand {get; set;}

            [Order(2)]
            public int MaxAppearTimesRand {get; set;}
        }
    ...
    public class AstrolabeRandomAddonEssence : IElementsType
    {
        ...
        [Order(4)]
        public int AddonRandomExpGained {get; set;}
    ...
    public class AstrolabeIncInnerPointValueEssence : IElementsType
    {
        ...
        [Order(4)]
        public int IncreaseBase {get; set;}

        [Order(5)]
        [Size(10)]
        public float[] IncreaseProbability {get; set;}

        [Order(6)]
        public int RequireMinAllInnerPointValue {get; set;}

        [Order(7)]
        public int RequireMaxAllInnerPointValue {get; set;}
    ...
    public class ItemPackageByProfessionEssence : IElementsType
    {
        ...
        [Order(4)]
        [Size(12)]
        public ProfListClass[] ProfList {get; set;}

        [Order(5)]
        public int ItemExpireTimelength {get; set;}
        ...
        public class ProfListClass
        {
            [Order(0)]
            [Size(2)]
            public uint[] GenderList {get; set;}
    ...
    public class AstrolabeAddonRandomConfig : IElementsType
    {
        ...
        [Order(3)]
        [Size(100)]
        public float[] RandProbability {get; set;}
    }
    ...
    public class EquipMakeHoleConfig : IElementsType
    {
        ...
        [Order(2)]
        [Size(20)]
        public LevelListClass[] LevelList {get; set;}

        public class LevelListClass
        {
            [Order(0)]
            [Size(4)]
            public HoleListClass[] HoleList {get; set;}
            ...
            public class HoleListClass
            {
                ...
                [Order(1)]
                public int RequireItemCount {get; set;}
    ...
    public class SoloTowerChallengeLevelConfig : IElementsType
    {
        ...
        [Order(3)]
        [Size(256)]
        public int[] ControllerIdToDeactivate {get; set;}
        ...
        public class RoomClass
        {
            ...
            [Order(1)]
            [Size(8)]
            public int[] ControllerIdToActivate {get; set;}
        }
        public class StepsClass
        {
            [Order(0)]
            [Size(32)]
            public uint[] PlayingMethodController {get; set;}

            [Order(1)]
            public int PlayingMethodBossController {get; set;}
        }
    ...
    public class SoloTowerChallengeAwardListConfig : IElementsType
    {
        ...
        {
            [Order(0)]
            public uint AwardPageConfigId {get; set;}

            [Order(1)]
            public uint DrawAwardTimes {get; set;}
    ...
    public class SoloTowerChallengeScoreCostConfig : IElementsType
    {
        ...
        [Order(2)]
        [Size(16)]
        public ScoreBuffListClass[] ScoreBuffList {get; set;}

        public class ScoreBuffListClass
        {
            [Order(0)]
            public uint ScoreCost {get; set;}
    ...
    public class MnfactionWarConfig : IElementsType
    {
        ...
        [Order(2)]
        public uint SignUpMoneyCost {get; set;}

        [Order(3)]
        public int ResourcePoint {get; set;}

        [Order(4)]
        public int ResourceTowerDestroyReducePoint {get; set;}

        [Order(5)]
        public int AttackerBossTid {get; set;}

        [Order(6)]
        public int DefenderBossTid {get; set;}

        [Order(7)]
        public int AttackerSmallBossTid {get; set;}

        [Order(8)]
        public int DefenderSmallBossTid {get; set;}

        [Order(9)]
        public int SmallBossDeathReducePoint {get; set;}

        [Order(10)]
        public int AttackerSmallBossControllerId {get; set;}

        [Order(11)]
        public int DefenderSmallBossControllerId {get; set;}

        [Order(12)]
        public int SmallBossAppearTime {get; set;}

        [Order(13)]
        public int DebuffAppearTime {get; set;}

        [Order(14)]
        public int DebuffInitRatio {get; set;}

        [Order(15)]
        public int DebuffEnhanceRatioPerMinute {get; set;}

        [Order(16)]
        [Size(4)]
        public DefenderResourceTowerClass[] AttackerResourceTower {get; set;}

        [Order(17)]
        [Size(4)]
        public DefenderResourceTowerClass[] DefenderResourceTower {get; set;}

        [Order(18)]
        [Size(4)]
        public NeutralTowerClass[] NeutralTower {get; set;}
        ...
        public class AttackerResourceTowerClass
        {
            ...
            [Order(1)]
            public int GuardControllerId {get; set;}
        ...
        public class DomainClass
        {
            [Order(0)]
            [Size(3)]
            public float[] AttackerIncomingPos {get; set;}

            [Order(1)]
            [Size(3)]
            public float[] DefenderIncomingPos {get; set;}

            [Order(2)]
            [Size(3)]
            public float[] AttackerTransmitPos {get; set;}

            [Order(3)]
            [Size(3)]
            public float[] DefenderTransmitPos {get; set;}

            [Order(4)]
            [Size(6)]
            public float[] ResurrectPos {get; set;}

            [Order(5)]
            public float ResurrectPosRange {get; set;}

            [Order(6)]
            public float ResourcePointRange {get; set;}

            [Order(7)]
            [Size(6)]
            public float[] ResoursePointPos {get; set;}

            [Order(8)]
            [Size(5)]
            public TransmitPosClass[] TransmitPos {get; set;}

            [Order(9)]
            public int DegreeTotal {get; set;}

            [Order(10)]
            public int DegreePerPersonSecond {get; set;}

            [Order(11)]
            public int GainResourcePointPerSecond {get; set;}

            [Order(12)]
            public int GainResourcePointInterval {get; set;}

            [Order(13)]
            public int ReduceResourcePointOnDeath {get; set;}
            ...
            public class TransmitPosClass
            {
                ...
                [Order(2)]
                [Size(3)]
                public float[] TransmitPos {get; set;}
            }
    ...
    public class NpcCrossServerService : IElementsType
    {
        ...
        [Order(5)]
        public int NeedItemTid {get; set;}
        ...
        [Order(8)]
        public int HistoryMaxLevelRequire {get; set;}

        [Order(9)]
        public int TaoistRankRequire {get; set;}

        [Order(10)]
        public int RealmLevelRequire {get; set;}
    }
    ...
    public class HomeConfig : IElementsType
    {
        ...
        [Order(4)]
        [Size(16)]
        public MapUnlockClass[] MapUnlock {get; set;}
        ...
        public class UpgradeClass
        {
            ...
            [Order(1)]
            public uint NeedHistoryMaxLevel {get; set;}

            [Order(2)]
            public uint NeedReincarnationTimes {get; set;}

            [Order(3)]
            public uint NeedRealmlevel {get; set;}
        }
        public class LevelClass
        {
            [Order(0)]
            ...
            [Order(1)]
            public uint Prosperous {get; set;}

            [Order(2)]
            public uint Clean {get; set;}

            [Order(3)]
            public uint MaxGrainCapacity {get; set;}

            [Order(4)]
            public uint MaxResourceCapacity {get; set;}
        }
        public class MapUnlockClass
        {
            [Order(0)]
            public uint HomeLevel {get; set;}
    ...
    public class HomeProductsConfig : IElementsType
    {
        ...
        [Order(4)]
        public int IsHaveSurfaceDisplay {get; set;}

        [Order(5)]
        public int Time {get; set;}

        [Order(6)]
        public int BuildingLevelMin {get; set;}

        [Order(7)]
        public int BuildingLevelMax {get; set;}

        [Order(8)]
        [Size(128)]
        public string FileMatterPrimary {get; set;}

        [Order(9)]
        [Size(128)]
        public string FileMatterGrowUp {get; set;}

        [Order(10)]
        [Size(128)]
        public string FileMatterRipe {get; set;}
        ...
        [Order(13)]
        public int CostGrainCount {get; set;}
    ...
    public class HomeResourceProduceConfig : IElementsType
    {
        ...
        [Order(3)]
        public float ProsperousEffectRatio {get; set;}
        ...
        public class LevelClass
        {
            ...
            [Order(1)]
            public uint MaxAddEnergyTime {get; set;}

            [Order(2)]
            public float ProduceMultiple {get; set;}

            [Order(3)]
            public uint UpgradeNeedHomeLevel {get; set;}

            [Order(4)]
            public uint UpgradeConsumeStoneNum {get; set;}

            [Order(5)]
            public uint UpgradeConsumeWoodNum {get; set;}

            [Order(6)]
            public uint UpgradeConsumeIronNum {get; set;}

            [Order(7)]
            public uint UpgradeConsumeClothNum {get; set;}

            [Order(8)]
            public uint UpgradeConsumeGrainNum {get; set;}

            [Order(9)]
            public uint UpgradeConsumeMoney {get; set;}
        }
    ...
    public class HomeFormulasProduceRecipe : IElementsType
    {
        ...
        [Order(5)]
        public int IsBaseFormulas {get; set;}
        ...
        [Order(8)]
        public uint HomeItemId {get; set;}

        [Order(9)]
        public float SuccessProbility {get; set;}

        [Order(10)]
        public uint Count {get; set;}

        [Order(11)]
        public uint TimeUse {get; set;}

        [Order(12)]
        public uint EnergyConsume {get; set;}

        [Order(13)]
        public uint HomeExpGain {get; set;}

        [Order(14)]
        public uint ProduceConsumeStoneNum {get; set;}

        [Order(15)]
        public uint ProduceConsumeWoodNum {get; set;}

        [Order(16)]
        public uint ProduceConsumeIronNum {get; set;}

        [Order(17)]
        public uint ProduceConsumeClothNum {get; set;}

        [Order(18)]
        public uint ProduceConsumeMoney {get; set;}
        ...
        public class MaterialClass
        {
            ...
            [Order(1)]
            public uint NormalItemId {get; set;}
    ...
    public class HomeFormulasItemEssence : IElementsType
    {
        ...
        [Order(6)]
        public uint FormulasId {get; set;}

        [Order(7)]
        public uint ProduceTimes {get; set;}
    ...
    public class HomeProduceServiceConfig : IElementsType
    {
        ...
        [Order(2)]
        [Size(128)]
        public ProduceListClass[] ProduceList {get; set;}
    ...
    public class HomeItemEntity : IElementsType
    {
        ...
        [Order(8)]
        public int MinGeneralProsperous {get; set;}

        [Order(9)]
        public int MaxGeneralProsperous {get; set;}

        [Order(10)]
        public int MinFineProsperous {get; set;}

        [Order(11)]
        public int MaxFineProsperous {get; set;}

        [Order(12)]
        public float FineRandProbability {get; set;}

        [Order(13)]
        public int Clean {get; set;}

        [Order(14)]
        public int MaxPlacedNum {get; set;}

        [Order(15)]
        public int IsPermitOutside {get; set;}

        [Order(16)]
        public int HangType {get; set;}

        [Order(17)]
        public int IsDisplay {get; set;}

        [Order(18)]
        public uint FactoryConfig {get; set;}

        [Order(19)]
        public uint ResourceConfig {get; set;}

        [Order(20)]
        public int ShowPriority {get; set;}

        [Order(21)]
        public int ForbidEquip {get; set;}
    }
    ...
    public class HomeStorageTaskConfig : IElementsType
    {
        ...
        [Order(2)]
        public uint RefreshTaskCountMin {get; set;}

        [Order(3)]
        public uint RefreshTaskCountMax {get; set;}

        [Order(4)]
        public uint RefreshTimes {get; set;}

        [Order(5)]
        public uint RefreshCostGrain {get; set;}

        [Order(6)]
        public uint DeliverTaskMax {get; set;}

        [Order(7)]
        [Size(16)]
        public TaskStorageClass[] TaskStorage {get; set;}

        public class TaskStorageClass
        {
            [Order(0)]
            public uint TaskOutServiceId {get; set;}

            [Order(1)]
            public uint FlourishMin {get; set;}

            [Order(2)]
            public uint FlourishMax {get; set;}
    ...
    public class RedPacketPaperEssence : IElementsType
    {
        ...
        [Order(7)]
        public int CashMin {get; set;}

        [Order(8)]
        public int CashMax {get; set;}

        [Order(9)]
        public int DeliverCountMin {get; set;}

        [Order(10)]
        public int DeliverCountMax {get; set;}
        ...
        [Order(12)]
        [Size(32)]
        public float[] SpecialItemCountRand {get; set;}
